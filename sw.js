const CACHE_NAME='hyosan-lpl-v5';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./assets/hyosan-app-icon.svg','./assets/hyosan-lpl-logo-full.svg','./assets/hyosan-app-icon-192.png','./assets/hyosan-app-icon-512.png'];
